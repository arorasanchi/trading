...
import com.sanchi.request.ForgotPasswordTokenRequest;
...
import com.sanchi.request.ResetPasswordRequest;
import com.sanchi.response.ApiResponse;
import com.sanchi.response.AuthResponse;
import com.sanchi.service.EmailService;
import com.sanchi.service.ForgotPasswordService;
import com.sanchi.service.UserService;
import com.sanchi.service.VerificationCodeService;
...
public class UserController {
    ...
    public ResponseEntity<AuthResponse> sendForgotPasswordOtp(
            ...
            ForgotPasswordToken token = forgotPasswordService.findByUser(
                    user.getId());
            if(token==null){
